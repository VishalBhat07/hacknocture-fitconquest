"""
run_webcam.py – Standalone webcam demo for the Squat Detector
=============================================================
Run:
...
def main():
    ...
    while cap.isOpened():
        ...
        cv2.imshow("Squat Detector – FitConquest", result["annotated_frame"])
    ...
    print(f"\nSession complete – Total squats: {detector.squat_count}")
