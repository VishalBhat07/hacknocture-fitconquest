...
export default function Feature2() {
  ...
  if (!user) {
    return (
      <div
        className="feature-page feature-2-page"
        id="feature-2-page"
        style={{ minHeight: "80vh", padding: "10rem 2rem" }}
      >
        <div
  ...
  return (
    <div
      className="feature-page feature-2-page"
      id="feature-2-page"
      style={{ alignItems: "flex-start", padding: "8rem 5% 4rem" }}
    >
      <div
        style={{
          width: "100%",
      ...
      >
        <div>
          ...
          <p className="subtitle" style={{ marginTop: "0.5rem" }}>
            Welcome back, {user.username}! Choose a challenge to start
            competing.
          </p>
        </div>
      ...
      <div style={{ width: "100%", marginBottom: "2rem" }}>
        <div
          style={{
            background:
              "linear-gradient(120deg, rgba(99,102,241,0.2), rgba(6,182,212,0.15))",
        ...
        >
          <div>
            ...
            >
              Not in the mood for team battles? Start a personal workout
              anytime.
            </p>
          </div>
          <Link
          ...
          return (
            ...
            >
              ...
              >
                ...
                >
                  <h4 style={{ color: "#ff8888", marginBottom: "0.5rem" }}>
                    Team Red
                  </h4>
                  <p style={{ fontSize: "0.9rem", color: "#aaa" }}>
                    {c.teams[0].members.length} Members
                  </p>
                ...
                >
                  <h4 style={{ color: "#88ccff", marginBottom: "0.5rem" }}>
                    Team Blue
                  </h4>
                  <p style={{ fontSize: "0.9rem", color: "#aaa" }}>
                    {c.teams[1].members.length} Members
                  </p>
                  {!isParticipant && c.status === "upcoming" && (
                    <button
